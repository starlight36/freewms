	...
	<form action="index.php?m=admin&amp;a=user&amp;do=edit&id=<?php echo $id; ?>" method="post">
		<div id="tabcontent">
			<div class="showsimplecon">
				...
				<p><span class="left alert bold"><?php echo Lang::_('admin_user_name_tip');?>: </span>
					<?php if(!$id):?>
						<input type="text" class="text shorttext" name="user_name" value="<?php echo Form::set_value('user_name', $uinfo['user_name']);?>" />
						<p><?php echo Form::get_error('user_name', '<span class="fielderrormsg">', '</span>');?>
					<?php else:	echo $uinfo['user_name'];?>
						<input type="hidden" name="user_name" value="<?php echo $uinfo['user_name'];?>"/>
					<?php endif?>
				</p>
                <p><span class="left alert bold"><?php echo Lang::_('admin_user_groupid_tip');?>: </span>
					<select name="user_groupid">
					<?php foreach ($glist as $row): ?>
					<option value="<? echo $row['group_id']?>" <?php if(Form::set_value('user_groupid', $uinfo['user_groupid']) == $row['group_id']){ echo "selected=\"selected\"";}?>>&nbsp;<?php echo $row['group_name']; ?></option>
					<?php endforeach; ?>
					</select>
                </p>
		    	<p><span class="left green bold"><?php echo Lang::_('admin_user_pass_tip');?>: </span>
					<input type="password" class="text shorttext" name="user_pass" />
					<?php echo Form::get_error('user_pass', '<span class="fielderrormsg">', '</span>');?>
			  	</p>
                <p><span class="left green bold"><?php echo Lang::_('admin_user_pass2_tip');?>: </span>
					<input type="password" class="text shorttext" name="user_pass2" />
                ...
                <p><span class="left"><?php echo Lang::_('admin_user_nickname_tip');?>: </span>
					<input type="txt" class="text shorttext" name="user_nickname" value="<?php echo Form::set_value('user_nickname', $userinfo['user_nickname']);?>" />
                ...
                <p><span class="left"><?php echo Lang::_('admin_user_gender_tip');?>: </span>
			  	...
			  	<p><span class="left alert bold"><?php echo Lang::_('admin_user_email_tip');?>: </span>
					<input type="txt" class="text shorttext" name="user_email" value="<?php echo Form::set_value('user_email', $uinfo['user_email']);?>" />
                ...
                <p><span class="left"><?php echo Lang::_('admin_user_birthday_tip');?>: </span>
					<input type="txt" class="text shorttext" name="user_birthday" value="<?php echo Form::set_value('user_birthday', $uinfo['user_birthday']);?>" />
                ...
                <p><span class="left"><?php echo Lang::_('admin_user_from_tip');?>: </span>
					<input type="txt" class="text shorttext" name="user_from" value="<?php echo Form::set_value('user_from', $uinfo['user_from']);?>" />
					<?php echo Form::get_error('user_from', '<span class="fielderrormsg">', '</span>');?>
                </p>
                <p><span class="left"><?php echo Lang::_('admin_user_qq_tip');?>: </span>
					<input type="txt" class="text shorttext" name="user_qq" value="<?php echo Form::set_value('user_qq', $uinfo['user_qq']);?>" />
					<?php echo Form::get_error('user_qq', '<span class="fielderrormsg">', '</span>');?>
                </p>

               	<p><span class="left"><?php echo Lang::_('admin_user_msn_tip');?>: </span>
					<input type="txt" class="text shorttext" name="user_msn" value="<?php echo Form::set_value('user_msn', $uinfo['user_msn']);?>" />
                ...
                <p><span class="left"><?php echo Lang::_('admin_user_homepage_tip');?>: </span>
					<input type="txt" class="text shorttext" name="user_homepage" value="<?php echo Form::set_value('user_homepage', $uinfo['user_homepage']);?>" />
                ...
                <p><span class="left"><?php echo Lang::_('admin_user_description_tip');?>: </span>
				 ...
				 <p><span class="left"><?php echo Lang::_('admin_user_adminvalid_tip');?>: </span>
					<label><input type="radio" name="user_adminvalid" value="1"<?php if(Form::set_value('user_adminvalid', $uinfo['user_adminvalid']) == '1'){echo ' checked="checked"';} ?> />&nbsp;<?php echo Lang::_('admin_user_adminvalid_yes');?></label>
					<label><input type="radio" name="user_adminvalid" value="0"<?php if(Form::set_value('user_adminvalid', $uinfo['user_adminvalid']) == '0'){echo ' checked="checked"';} ?> />&nbsp;<?php echo Lang::_('admin_user_adminvalid_no');?></label>
                </p>
				 <p><span class="left"><?php echo Lang::_('admin_user_emailvalid_tip');?>: </span>
					<label><input type="radio" name="user_emailvalid" value="1"<?php if(Form::set_value('user_emailvalid', $uinfo['user_emailvalid']) == '1'){echo ' checked="checked"';} ?> />&nbsp;<?php echo Lang::_('admin_user_emailvalid_yes');?></label>
					<label><input type="radio" name="user_emailvalid" value="0"<?php if(Form::set_value('user_emailvalid', $uinfo['user_emailvalid']) == '0'){echo ' checked="checked"';} ?> />&nbsp;<?php echo Lang::_('admin_user_emailvalid_no');?></label>
                </p>
