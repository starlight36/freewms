...
<link rel="stylesheet" rev="stylesheet" href="<?php echo base_url(); ?>skin/admin/styles.css" type="text/css" media="all" />
...
<div id="loginpage" class="moditem">
	<form id="loginform" action="<?php echo site_url('admin/login'); ?>" method="post">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="moditem">
			...
			<tr>
				<td colspan="2"><div class="errormsg"><?php echo validation_errors(); ?></div></td>
			</tr>
			<?php endif; ?>
			<tr>
				<td class="labelcol">用户名：</td>
				<td><input type="text" name="admin" id="admin" value="<?php echo set_value('admin'); ?>" /></td>
			</tr>
			<tr>
				<td class="labelcol">密码：</td>
				<td><input name="passwd" type="password" id="passwd" value="<?php echo set_value('passwd'); ?>" /></td>
			</tr>
			<tr>
