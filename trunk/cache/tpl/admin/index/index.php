	...
	<div id="guidetree">
		...
		<div class="wrapitem">
			<div class="treeitem">
				<div>网站系统设置</div>
				<ul>
					<li><a href="<?php echo site_url(''); ?>" title="常规设置">系统参数设置</a></li>
					<li><a href="<?php echo base_url(); ?>" title="常规设置">全站频道设置</a></li>
					<li><a href="<?php echo base_url(); ?>" title="常规设置">全站专题管理</a></li>
					<li><a href="<?php echo base_url(); ?>" title="常规设置">上传附件管理</a></li>
					<li><a href="<?php echo base_url(); ?>" title="常规设置">全站广告管理</a></li>
					<li><a href="<?php echo base_url(); ?>" title="常规设置">友情链接管理</a></li>
					<li><a href="<?php echo base_url(); ?>" title="常规设置">投票调查管理</a></li>
					<li><a href="<?php echo base_url(); ?>" title="常规设置">关键字管理</a></li>
					<li><a href="<?php echo base_url(); ?>" title="常规设置">全站TAG管理</a></li>
					<li><a href="<?php echo base_url(); ?>" title="常规设置">脏字过滤管理</a></li>
					<li><a href="<?php echo base_url(); ?>" title="常规设置">功能模块管理</a></li>
				</ul>
			</div>
		</div>
		<div class="wrapitem">
